				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="alert alert-info version-check">
							<p>You are running <strong>MOOC v<span id="version">{version}</span></strong>.</p>
						</div>
						<p>
							Always make sure that your MOOC is up to date for the latest security patches and bug fixes.
						</p>
						<p class="text-center">
						...
						<p class="help-block text-center">
							Restarting your MOOC will drop all existing connections. A reload is lighter and is probably
